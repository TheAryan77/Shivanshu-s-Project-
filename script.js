// API keys are loaded from config.js (not tracked in git)
...
TIPS: [your weather tips here]`;
    ...
    try {
        ...
        aiInsights.innerHTML = `<p>⚠️ Unable to generate AI insights at the moment. Please check your Groq API key.</p>`;
